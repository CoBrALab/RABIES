...
N4BiasFieldCorrection -d 3 -i resampled.nii.gz -b 20 -s 1 -c [100x100x100x100,1e-6] -w thresh_mask.nii.gz -x null_mask.nii.gz -o corrected.nii.gz
...
antsApplyTransforms -d 3 -i $mask -t ${filename_template}_output_InverseComposite.h5 -r resampled.nii.gz -o ${filename_template}_resampled_mask.nii.gz -n GenericLabel
