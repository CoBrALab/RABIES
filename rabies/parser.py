...
def get_parser():
    ...
    g_registration.add_argument(
        ...
        help=
            ...
            "--brain_mask, --WM_mask, --CSF_mask, --vascular_mask \n"
            "(default: %(default)s)\n"
            "\n"
        )
    g_registration.add_argument(
    ...
    confound_correction.add_argument(
        ...
        help=
            ...
            "*** Specify 'true' or 'false'. \n"
            "* censoring_percent_exclusion: Sets the minimum percentage of timepoints that must be left after \n"
            " censoring. If fewer are left, an empty file is generated and the scan is excluded from \n"
