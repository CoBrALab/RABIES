...
def init_bold_preproc_trans_wf(opts, resampling_dim, name='bold_native_trans_wf'):
    ...
    bold_transform_mot_only = pe.Node(slice_applyTransforms(
        rabies_data_type=opts.data_type), name='bold_transform_mot_only', mem_gb=1*opts.scale_min_memory)
    bold_transform_mot_only.inputs.apply_motcorr = (not opts.apply_slice_mc)
    ...
    bold_transform_mot_only.inputs.interpolation = opts.interpolation
    ...
    bold_transform_trans_only.inputs.interpolation = opts.interpolation
    ...
    merge_mot_only = pe.Node(Merge(rabies_data_type=opts.data_type, clip_negative=True), 
                            name='merge_mot_only', 
