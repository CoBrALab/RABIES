...
def init_analysis_wf(TR,FC_matrix=False,group_ICA=False,DR_ICA=False,name="analysis_wf"):

    workflow = pe.Workflow(name=name)
    inputnode = pe.Node(niu.IdentityInterface(fields=['bold_file', 'brain_mask', 'atlas_file']), name='inputnode')
