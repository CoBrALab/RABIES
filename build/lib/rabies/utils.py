...
class slice_applyTransforms(BaseInterface):
    ...
    def _run_interface(self, runtime):
        ...
        for x in range(0, num_volumes):
            ...
            exec_applyTransforms(transforms, inverses, bold_volumes[x], ref_img, warped_vol_fname, interpolation='GenericLabel')
...
def exec_applyTransforms(transforms, inverses, input_image, ref_image, output_image, interpolation='GenericLabel'):
