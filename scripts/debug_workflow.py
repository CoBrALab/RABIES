...
args = [
        ...
        '--bold2anat_coreg', 'registration=no_reg,masking=false,brain_extraction=false,winsorize_lower_bound=0.005,winsorize_upper_bound=0.995', 
        '--commonspace_reg', 'masking=false,brain_extraction=false,fast_commonspace=true,template_registration=no_reg,winsorize_lower_bound=0.005,winsorize_upper_bound=0.995', 
        '--data_type', 'int16', 
