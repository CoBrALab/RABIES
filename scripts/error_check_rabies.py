...
array_4d += np.random.normal(0,array_4d.mean()/1000,array_4d.shape) # add gaussian noise
...
command = "rabies preprocess %s/inputs %s/outputs --debug --anat_bias_cor_method disable --bold_bias_cor_method disable \
    ...
    --coreg_script null_nonlin --template_reg_script null_nonlin --data_type int16" % (tmppath,tmppath,tmppath,tmppath,tmppath,tmppath,tmppath,tmppath)
