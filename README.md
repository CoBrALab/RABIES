...
- containerized distribution of the software hosted on [GitHub Container Registry](https://github.com/CoBrALab/RABIES/pkgs/container/rabies) which can be downloaded via Docker and Apptainer platforms
